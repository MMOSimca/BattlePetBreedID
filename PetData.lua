...
Last Update: Patch 8.1.0 Live; @file-date-iso@
...
function BPBID_Arrays.InitializeArrays()
    ...
    BPBID_Arrays.BreedsPerSpecies[2539] = false
    BPBID_Arrays.BreedsPerSpecies[2540] = false
    ...
    BPBID_Arrays.BreedsPerSpecies[2557] = {17}
