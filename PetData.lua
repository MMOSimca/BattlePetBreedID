...
function BPBID_Arrays.InitializeArrays()
    ...
    --BPBID_Arrays.BreedsPerSpecies[1699] = {???} -- NEW: Enchanted Cauldron
    --BPBID_Arrays.BreedsPerSpecies[1700] = {???} -- NEW: Enchanted Torch
    --BPBID_Arrays.BreedsPerSpecies[1701] = {???} -- NEW: Enchanted Pen
    --BPBID_Arrays.BreedsPerSpecies[1705] = {???} -- NEW: Grumpy
    BPBID_Arrays.BreedsPerSpecies[1706] = {6} -- NEW: Ashmaw Cub
    --BPBID_Arrays.BreedsPerSpecies[1708] = {???} -- NEW: Albatross Chick
    --BPBID_Arrays.BreedsPerSpecies[1709] = {???} -- NEW: Fledgling Kingfeather
    --BPBID_Arrays.BreedsPerSpecies[1710] = {???} -- NEW: Fledgling Oliveback
    --BPBID_Arrays.BreedsPerSpecies[1711] = {???} -- NEW: Skyhorn Nestling
    --BPBID_Arrays.BreedsPerSpecies[1712] = {???} -- NEW: Golden Eaglet
    --BPBID_Arrays.BreedsPerSpecies[1713] = {???} -- NEW: Long-Eared Owl
    --BPBID_Arrays.BreedsPerSpecies[1714] = {???} -- NEW: Northern Hawk Owl
    BPBID_Arrays.BreedsPerSpecies[1715] = {8} -- NEW: Nightwatch Swooper
    --BPBID_Arrays.BreedsPerSpecies[1716] = {???} -- NEW: Fledgling Warden Owl
    --BPBID_Arrays.BreedsPerSpecies[1717] = {???} -- NEW: Extinguished Eye
    --BPBID_Arrays.BreedsPerSpecies[1718] = {???} -- NEW: Hateful Eye
    --BPBID_Arrays.BreedsPerSpecies[1719] = {???} -- NEW: Eye of Inquisition
    BPBID_Arrays.BreedsPerSpecies[1720] = {8} -- NEW: Emmigosa
    --BPBID_Arrays.BreedsPerSpecies[1721] = {???} -- NEW: Stormborne Whelpling
    --BPBID_Arrays.BreedsPerSpecies[1722] = {???} -- NEW: Dream Whelpling
    --BPBID_Arrays.BreedsPerSpecies[1723] = {???} -- NEW: Nightmare Whelpling
    --BPBID_Arrays.BreedsPerSpecies[1726] = {???} -- NEW: Burrow Spiderling
    BPBID_Arrays.BreedsPerSpecies[1727] = {11} -- NEW: Nursery Spider
    --BPBID_Arrays.BreedsPerSpecies[1728] = {???} -- NEW: Juvenile Scuttleback
    BPBID_Arrays.BreedsPerSpecies[1729] = {7} -- NEW: Olivetail Hare
    --BPBID_Arrays.BreedsPerSpecies[1731] = {???} -- NEW: Felspider
    --BPBID_Arrays.BreedsPerSpecies[1734] = {???} -- NEW: Shimmering Aquafly
    --BPBID_Arrays.BreedsPerSpecies[1735] = {???} -- NEW: Terror Larva
    BPBID_Arrays.BreedsPerSpecies[1736] = {5} -- NEW: Slithering Brownscale
    --BPBID_Arrays.BreedsPerSpecies[1737] = {???} -- NEW: Vale Flitter
    --BPBID_Arrays.BreedsPerSpecies[1738] = {???} -- NEW: Auburn Ringtail
    --BPBID_Arrays.BreedsPerSpecies[1739] = {???} -- NEW: Spring Strider
    --BPBID_Arrays.BreedsPerSpecies[1742] = {???} -- NEW: Master Tamer Flummox
    --BPBID_Arrays.BreedsPerSpecies[1743] = {???} -- NEW: Black-Footed Fox Kit
    --BPBID_Arrays.BreedsPerSpecies[1744] = {???} -- NEW: Mist Fox Kit
    --BPBID_Arrays.BreedsPerSpecies[1745] = {???} -- NEW: Marshmallow
    --BPBID_Arrays.BreedsPerSpecies[1746] = {???} -- NEW: Rocket
    --BPBID_Arrays.BreedsPerSpecies[1748] = {???} -- NEW: Jinx
    --BPBID_Arrays.BreedsPerSpecies[1749] = {???} -- NEW: Rose Taipan
    --BPBID_Arrays.BreedsPerSpecies[1750] = {???} -- NEW: Tiny Apparition
    --BPBID_Arrays.BreedsPerSpecies[1751] = {???} -- NEW: Son of Goredome
    --BPBID_Arrays.BreedsPerSpecies[1752] = {???} -- NEW: Crispin
    BPBID_Arrays.BreedsPerSpecies[1753] = {8} -- NEW: Bleakwater Jelly
    --BPBID_Arrays.BreedsPerSpecies[1754] = {???} -- NEW: Sewer-Pipe Jelly
    BPBID_Arrays.BreedsPerSpecies[1755] = {12} -- NEW: Plump Jelly
    --BPBID_Arrays.BreedsPerSpecies[1756] = {???} -- NEW: Ridgeback Piglet
    --BPBID_Arrays.BreedsPerSpecies[1757] = {???} -- NEW: Brown Piglet
    --BPBID_Arrays.BreedsPerSpecies[1758] = {???} -- NEW: Black Piglet
    --BPBID_Arrays.BreedsPerSpecies[1759] = {???} -- NEW: Thaumaturgical Piglet
    BPBID_Arrays.BreedsPerSpecies[1760] = {8} -- NEW: Fel Piglet
    --BPBID_Arrays.BreedsPerSpecies[1761] = {???} -- NEW: Echo Batling
    --BPBID_Arrays.BreedsPerSpecies[1762] = {???} -- NEW: Hog-Nosed Bat
    --BPBID_Arrays.BreedsPerSpecies[1763] = {???} -- NEW: Spiketail Beaver
    --BPBID_Arrays.BreedsPerSpecies[1770] = {???} -- NEW: Thrugtusk
    --BPBID_Arrays.BreedsPerSpecies[1771] = {???} -- NEW: Baeloth
    --BPBID_Arrays.BreedsPerSpecies[1772] = {???} -- NEW: Wumpas
    --BPBID_Arrays.BreedsPerSpecies[1773] = {???} -- NEW: Erudite Manafiend
    --BPBID_Arrays.BreedsPerSpecies[1774] = {???} -- NEW: Eldritch Manafiend
    --BPBID_Arrays.BreedsPerSpecies[1775] = {???} -- NEW: Coralback Fiddler
    --BPBID_Arrays.BreedsPerSpecies[1776] = {???} -- NEW: Mudshell Conch
    --BPBID_Arrays.BreedsPerSpecies[1777] = {???} -- NEW: Broot
    --BPBID_Arrays.BreedsPerSpecies[1778] = {???} -- NEW: Dust Bunny
    --BPBID_Arrays.BreedsPerSpecies[1780] = {???} -- NEW: Kiazor the Destroyer
    --BPBID_Arrays.BreedsPerSpecies[1781] = {???} -- NEW: Scuttles
    --BPBID_Arrays.BreedsPerSpecies[1782] = {???} -- NEW: Clamps
    --BPBID_Arrays.BreedsPerSpecies[1787] = {???} -- NEW: Roots
    --BPBID_Arrays.BreedsPerSpecies[1788] = {???} -- NEW: Beaky
    --BPBID_Arrays.BreedsPerSpecies[1789] = {???} -- NEW: Sunny
    --BPBID_Arrays.BreedsPerSpecies[1790] = {???} -- NEW: Lil' Spirit Guide
    --BPBID_Arrays.BreedsPerSpecies[1791] = {???} -- NEW: Quillino
    --BPBID_Arrays.BreedsPerSpecies[1792] = {???} -- NEW: Fethyr
    --BPBID_Arrays.BreedsPerSpecies[1793] = {???} -- NEW: Egcellent
    --BPBID_Arrays.BreedsPerSpecies[1794] = {???} -- NEW: Red Wire
    --BPBID_Arrays.BreedsPerSpecies[1795] = {???} -- NEW: Sir Murkeston
    --BPBID_Arrays.BreedsPerSpecies[1796] = {???} -- NEW: Coach
    --BPBID_Arrays.BreedsPerSpecies[1797] = {???} -- NEW: Greatest Foe
    --BPBID_Arrays.BreedsPerSpecies[1798] = {???} -- NEW: Gulp
    --BPBID_Arrays.BreedsPerSpecies[1799] = {???} -- NEW: Grommet
    --BPBID_Arrays.BreedsPerSpecies[1800] = {???} -- NEW: Itchy
    --BPBID_Arrays.BreedsPerSpecies[1801] = {???} -- NEW: Salty Bird
    --BPBID_Arrays.BreedsPerSpecies[1802] = {???} -- NEW: Fetid Waveling
    --BPBID_Arrays.BreedsPerSpecies[1803] = {???} -- NEW: Thistleleaf Adventurer
    --BPBID_Arrays.BreedsPerSpecies[1804] = {???} -- NEW: Risen Saber Kitten
    BPBID_Arrays.BreedsPerSpecies[1805] = {6} -- NEW: Alarm-o-Bot
    --BPBID_Arrays.BreedsPerSpecies[1806] = {???} -- NEW: Knockoff Blingtron
    --BPBID_Arrays.BreedsPerSpecies[1807] = {???} -- NEW: Vicious Broodling
    --BPBID_Arrays.BreedsPerSpecies[1808] = {???} -- NEW: Leyline Broodling
    --BPBID_Arrays.BreedsPerSpecies[1809] = {???} -- NEW: Crystalline Broodling
    --BPBID_Arrays.BreedsPerSpecies[1810] = {???} -- NEW: Thornclaw Broodling
    --BPBID_Arrays.BreedsPerSpecies[1811] = {???} -- NEW: Rocko
    --BPBID_Arrays.BreedsPerSpecies[1815] = {???} -- NEW: Heliosus
    --BPBID_Arrays.BreedsPerSpecies[1816] = {???} -- NEW: Mini Magmatron
    --BPBID_Arrays.BreedsPerSpecies[1817] = {???} -- NEW: Mini Arcanotron
    --BPBID_Arrays.BreedsPerSpecies[1818] = {???} -- NEW: Mini Electron
    BPBID_Arrays.BreedsPerSpecies[1828] = {7} -- NEW: Baby Winston
    --BPBID_Arrays.BreedsPerSpecies[1840] = {???} -- NEW: Snot
    --BPBID_Arrays.BreedsPerSpecies[1841] = {???} -- NEW: Slow Moe
    --BPBID_Arrays.BreedsPerSpecies[1842] = {???} -- NEW: Rocklick
    --BPBID_Arrays.BreedsPerSpecies[1843] = {???} -- NEW: Hungry Icefang
    --BPBID_Arrays.BreedsPerSpecies[1846] = {???} -- NEW: Globs
    --BPBID_Arrays.BreedsPerSpecies[1847] = {???} -- NEW: Trixy
    --BPBID_Arrays.BreedsPerSpecies[1848] = {???} -- NEW: Nightmare Sprout
    --BPBID_Arrays.BreedsPerSpecies[1849] = {???} -- NEW: The Maw
    --BPBID_Arrays.BreedsPerSpecies[1850] = {???} -- NEW: Thistleleaf Bully
    --BPBID_Arrays.BreedsPerSpecies[1851] = {???} -- NEW: Cackling Flame
    --BPBID_Arrays.BreedsPerSpecies[1852] = {???} -- NEW: Devouring Blaze
    --BPBID_Arrays.BreedsPerSpecies[1853] = {???} -- NEW: Living Coals
    --BPBID_Arrays.BreedsPerSpecies[1855] = {???} -- NEW: Splint Jr.
    --BPBID_Arrays.BreedsPerSpecies[1857] = {???} -- NEW: Beauty
    --BPBID_Arrays.BreedsPerSpecies[1858] = {???} -- NEW: Conviction
    --BPBID_Arrays.BreedsPerSpecies[1859] = {???} -- NEW: Dignity
    --BPBID_Arrays.BreedsPerSpecies[1860] = {???} -- NEW: Ancient Catacomb Spider
    --BPBID_Arrays.BreedsPerSpecies[1861] = {???} -- NEW: Catacomb Bat
    --BPBID_Arrays.BreedsPerSpecies[1862] = {???} -- NEW: Catacomb Snake
    --BPBID_Arrays.BreedsPerSpecies[1863] = {???} -- NEW: Font of Mana
    --BPBID_Arrays.BreedsPerSpecies[1864] = {???} -- NEW: Seed of Mana
    --BPBID_Arrays.BreedsPerSpecies[1865] = {???} -- NEW: Essence of Mana
    --BPBID_Arrays.BreedsPerSpecies[1866] = {???} -- NEW: Baby Bjorn
    --BPBID_Arrays.BreedsPerSpecies[1867] = {???} -- NEW: Mini Musken
    --BPBID_Arrays.BreedsPerSpecies[1868] = {???} -- NEW: Mist Wraith
    --BPBID_Arrays.BreedsPerSpecies[1869] = {???} -- NEW: Crawdead
    --BPBID_Arrays.BreedsPerSpecies[1870] = {???} -- NEW: Gnaw
    --BPBID_Arrays.BreedsPerSpecies[1871] = {???} -- NEW: Harbinger of Dark
    --BPBID_Arrays.BreedsPerSpecies[1872] = {???} -- NEW: Herald of Light
    --BPBID_Arrays.BreedsPerSpecies[1873] = {???} -- NEW: Gusteau
    --BPBID_Arrays.BreedsPerSpecies[1874] = {???} -- NEW: Remy
    --BPBID_Arrays.BreedsPerSpecies[1875] = {???} -- NEW: Dinner
    --BPBID_Arrays.BreedsPerSpecies[1877] = {???} -- NEW: Eye of Inquisition
    --BPBID_Arrays.BreedsPerSpecies[1878] = {???} -- NEW: Eye of Interrogation
    --BPBID_Arrays.BreedsPerSpecies[1879] = {???} -- NEW: Eye of Impetration
    --BPBID_Arrays.BreedsPerSpecies[1880] = {???} -- NEW: Stitches Jr. Jr.
    --BPBID_Arrays.BreedsPerSpecies[1881] = {???} -- NEW: Lil'idan
    --BPBID_Arrays.BreedsPerSpecies[1882] = {???} -- NEW: Chromadon
    --BPBID_Arrays.BreedsPerSpecies[1883] = {???} -- NEW: Blottis
    --BPBID_Arrays.BreedsPerSpecies[1884] = {???} -- NEW: Baby Elderhorn
    --BPBID_Arrays.BreedsPerSpecies[1885] = {???} -- NEW: Sunborne Val'kyr
    --BPBID_Arrays.BreedsPerSpecies[1886] = {???} -- NEW: Trigger
    --BPBID_Arrays.BreedsPerSpecies[1887] = {???} -- NEW: Wyrmy Tunkins
    --BPBID_Arrays.BreedsPerSpecies[1888] = {???} -- NEW: Celestial Calf
    BPBID_Arrays.BreedsPerSpecies[1889] = {11} -- NEW: Felbat Pup
    --BPBID_Arrays.BreedsPerSpecies[1890] = {???} -- NEW: Corgi Pup
    --BPBID_Arrays.BreedsPerSpecies[1891] = {???} -- NEW: Vinu
    --BPBID_Arrays.BreedsPerSpecies[1892] = {???} -- NEW: Subjugated Tadpole
    --BPBID_Arrays.BreedsPerSpecies[1893] = {???} -- NEW: Allured Tadpole
    --BPBID_Arrays.BreedsPerSpecies[1894] = {???} -- NEW: Confused Tadpole
    --BPBID_Arrays.BreedsPerSpecies[1895] = {???} -- NEW: Hungry Owl
    --BPBID_Arrays.BreedsPerSpecies[1896] = {???} -- NEW: Hungry Rat
    --BPBID_Arrays.BreedsPerSpecies[1897] = {???} -- NEW: Breezy Book
    --BPBID_Arrays.BreedsPerSpecies[1898] = {???} -- NEW: Helpful Spirit
    --BPBID_Arrays.BreedsPerSpecies[1899] = {???} -- NEW: Delicate Moth
    --BPBID_Arrays.BreedsPerSpecies[1903] = {???} -- NEW: Zoom
    --BPBID_Arrays.BreedsPerSpecies[1904] = {???} -- NEW: Stumpers
    --BPBID_Arrays.BreedsPerSpecies[1905] = {???} -- NEW: Foof
    --BPBID_Arrays.BreedsPerSpecies[1906] = {???} -- NEW: Lil' Sizzle
    BPBID_Arrays.BreedsPerSpecies[1907] = {8} -- NEW: Pygmy Owl
    --BPBID_Arrays.BreedsPerSpecies[1911] = {???} -- NEW: Sting Ray Pup
    --BPBID_Arrays.BreedsPerSpecies[1912] = {???} -- NEW: Young Mutant Warturtle
    --BPBID_Arrays.BreedsPerSpecies[1913] = {???} -- NEW: Gleamhoof Fawn
    --BPBID_Arrays.BreedsPerSpecies[1914] = {???} -- NEW: Coastal Sandpiper
    --BPBID_Arrays.BreedsPerSpecies[1915] = {???} -- NEW: Blind Rat
    --BPBID_Arrays.BreedsPerSpecies[1917] = {???} -- NEW: Stormstruck Beaver
    --BPBID_Arrays.BreedsPerSpecies[1918] = {???} -- NEW: Alliance Enthusiast
    --BPBID_Arrays.BreedsPerSpecies[1919] = {???} -- NEW: Horde Fanatic
    --BPBID_Arrays.BreedsPerSpecies[1920] = {???} -- NEW: Transmutant
    --BPBID_Arrays.BreedsPerSpecies[1921] = {???} -- NEW: Untethered Wyrmling
    --BPBID_Arrays.BreedsPerSpecies[1922] = {???} -- NEW: Lurking Owl Kitten
    --BPBID_Arrays.BreedsPerSpecies[1926] = {???} -- NEW: Hungering Claw
    --BPBID_Arrays.BreedsPerSpecies[1927] = {???} -- NEW: Ash'ana
    --BPBID_Arrays.BreedsPerSpecies[1928] = {???} -- NEW: Firebat Pup
    --BPBID_Arrays.BreedsPerSpecies[1929] = {???} -- NEW: Corgnelius
    --BPBID_Arrays.BreedsPerSpecies[1930] = {???} -- NEW: Lagan
    --BPBID_Arrays.BreedsPerSpecies[1931] = {???} -- NEW: Court Scribe
    --BPBID_Arrays.BreedsPerSpecies[1932] = {???} -- NEW: Nightmare Lasher
    --BPBID_Arrays.BreedsPerSpecies[1933] = {???} -- NEW: Nightmare Treant
    --BPBID_Arrays.BreedsPerSpecies[1934] = {???} -- NEW: Benax
    --BPBID_Arrays.BreedsPerSpecies[1935] = {???} -- NEW: Squirky
    --BPBID_Arrays.BreedsPerSpecies[1937] = {???} -- NEW: Wonderous Wisdomball
    --BPBID_Arrays.BreedsPerSpecies[1938] = {???} -- NEW: Rescued Fawn
    --BPBID_Arrays.BreedsPerSpecies[1941] = {???} -- NEW: Snowfang
end
