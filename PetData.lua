...
function BPBID_Arrays.InitializeArrays()
    ...
    BPBID_Arrays.BreedsPerSpecies[1708] = {3, 11} -- NEW: Albatross Chick
    ...
    BPBID_Arrays.BreedsPerSpecies[1712] = {3, 8, 10} -- NEW: Golden Eaglet
    BPBID_Arrays.BreedsPerSpecies[1713] = {3, 4, 5, 10} -- NEW: Long-Eared Owl
    ...
    BPBID_Arrays.BreedsPerSpecies[1726] = {3, 8, 11} -- NEW: Burrow Spiderling
    ...
    BPBID_Arrays.BreedsPerSpecies[1729] = {3, 7, 9, 11, 12} -- NEW: Olivetail Hare
    BPBID_Arrays.BreedsPerSpecies[1731] = {3, 5, 8, 11} -- NEW: Felspider
    BPBID_Arrays.BreedsPerSpecies[1734] = {8, 9, 11} -- NEW: Shimmering Aquafly
    BPBID_Arrays.BreedsPerSpecies[1735] = {6} -- NEW: Terror Larva
    BPBID_Arrays.BreedsPerSpecies[1736] = {3, 5, 11} -- NEW: Slithering Brownscale
    BPBID_Arrays.BreedsPerSpecies[1737] = {4, 7} -- NEW: Vale Flitter
    BPBID_Arrays.BreedsPerSpecies[1738] = {5, 8} -- NEW: Auburn Ringtail
    BPBID_Arrays.BreedsPerSpecies[1739] = {9, 11, 12} -- NEW: Spring Strider
    ...
    BPBID_Arrays.BreedsPerSpecies[1749] = {5, 8, 10, 11} -- NEW: Rose Taipan
    BPBID_Arrays.BreedsPerSpecies[1750] = {6} -- NEW: Tiny Apparition
    ...
    BPBID_Arrays.BreedsPerSpecies[1761] = {8, 9} -- NEW: Echo Batling
    BPBID_Arrays.BreedsPerSpecies[1762] = {4, 7, 9} -- NEW: Hog-Nosed Bat
    ...
    BPBID_Arrays.BreedsPerSpecies[1775] = {8, 11} -- NEW: Coralback Fiddler
    ...
    BPBID_Arrays.BreedsPerSpecies[1917] = {4} -- NEW: Stormstruck Beaver
