...
Last Update: September 30th, 2014; Patch 6.0.2 PTR/Beta
...
function BPBID_Arrays.InitializeArrays()
    ...
    --BPBID_Arrays.BasePetStats[1385] = ??? -- NEW: Albino Chimaeraling
    ...
    --BPBID_Arrays.BasePetStats[1394] = ??? -- NEW: Weebomination
    --BPBID_Arrays.BasePetStats[1395] = ??? -- NEW: Lil' Leftovers
    --BPBID_Arrays.BasePetStats[1396] = ??? -- NEW: Crazy Carrot
    --BPBID_Arrays.BasePetStats[1400] = ??? -- TAMER: Deebs
    --BPBID_Arrays.BasePetStats[1401] = ??? -- TAMER: Tyri
    --BPBID_Arrays.BasePetStats[1402] = ??? -- TAMER: Puzzle
    --BPBID_Arrays.BasePetStats[1403] = ??? -- NEW: Mechanical Axebeak
    --BPBID_Arrays.BasePetStats[1409] = ??? -- TAMER: Eleanor
    --BPBID_Arrays.BasePetStats[1410] = ??? -- TAMER: Mechanical Training Dummy
    --BPBID_Arrays.BasePetStats[1411] = ??? -- NEW: Royal Peacock
    --BPBID_Arrays.BasePetStats[1412] = ??? -- NEW: Lifelike Mechanical Frostboar
    BPBID_Arrays.BasePetStats[1416] = {8, 8, 8} -- NEW: Teroclaw Hatchling
    --BPBID_Arrays.BasePetStats[1420] = ??? -- TAMER: Evil Widowling
    --BPBID_Arrays.BasePetStats[1423] = ??? -- TAMER: Bitey
    --BPBID_Arrays.BasePetStats[1424] = ??? -- TAMER: Gyrexle, the Eternal Mechanic
    BPBID_Arrays.BasePetStats[1426] = {13, 8, 5.5} -- NEW: Elekk Plushie
    --BPBID_Arrays.BasePetStats[1427] = ??? -- NEW: Gnawtooth Rat
    --BPBID_Arrays.BasePetStats[1428] = ??? -- NEW: Zomstrok
    --BPBID_Arrays.BasePetStats[1429] = ??? -- TAMER: Autumnal Sproutling
    --BPBID_Arrays.BasePetStats[1430] = ??? -- TAMER: Forest Sproutling
    --BPBID_Arrays.BasePetStats[1431] = ??? -- TAMER: Kelp Sproutling
    --BPBID_Arrays.BasePetStats[1432] = ??? -- NEW: Nightshade Sproutling
    --BPBID_Arrays.BasePetStats[1433] = ??? -- TAMER: Sassy Sproutling
    --BPBID_Arrays.BasePetStats[1434] = ??? -- NEW: Sun Sproutling
    BPBID_Arrays.BasePetStats[1435] = {9, 8.5, 6.5} -- NEW: Leatherhide Runt
    BPBID_Arrays.BasePetStats[1441] = {8.5, 7.5, 8} -- NEW: Mud Jumper
    --BPBID_Arrays.BasePetStats[1442] = ??? -- NEW: Ghastly Kid
    --BPBID_Arrays.BasePetStats[1443] = ??? -- TAMER: Idol of Decay
    --BPBID_Arrays.BasePetStats[1444] = ??? -- TAMER: Wishbright Lantern
    --BPBID_Arrays.BasePetStats[1446] = ??? -- NEW: Meadowstomper Calf
    BPBID_Arrays.BasePetStats[1447] = {8, 8, 8} -- NEW: Moonshell Crab
    --BPBID_Arrays.BasePetStats[1448] = ??? -- NEW: Sea Calf
    --BPBID_Arrays.BasePetStats[1449] = ??? -- NEW: Deathwatch Hatchling
    --BPBID_Arrays.BasePetStats[1450] = ??? -- NEW: Draenei Micro Defender
    --BPBID_Arrays.BasePetStats[1451] = ??? -- NEW: Molten Corgi
    --BPBID_Arrays.BasePetStats[1453] = ??? -- TAMER: River Calf
    --BPBID_Arrays.BasePetStats[1454] = ??? -- TAMER: Dwarf Gronnling
    BPBID_Arrays.BasePetStats[1455] = {8, 8, 8} -- NEW: Mossbite Skitterer
    --BPBID_Arrays.BasePetStats[1456] = ??? -- NEW: Thicket Skitterer
    --BPBID_Arrays.BasePetStats[1457] = ??? -- NEW: Icespine Hatchling
    --BPBID_Arrays.BasePetStats[1458] = ??? -- NEW: Bone Wasp
    --BPBID_Arrays.BasePetStats[1462] = ??? -- NEW: Bloodsting Wasp
    --BPBID_Arrays.BasePetStats[1463] = ??? -- NEW: Wood Wasp
    --BPBID_Arrays.BasePetStats[1464] = ??? -- NEW: Twilight Wasp
    --BPBID_Arrays.BasePetStats[1465] = ??? -- NEW: Amberbarb Wasp
    --BPBID_Arrays.BasePetStats[1466] = ??? -- TAMER: Runtish Gronnling
    --BPBID_Arrays.BasePetStats[1467] = ??? -- NEW: Sky-Bo
    --BPBID_Arrays.BasePetStats[1468] = ??? -- TAMER: Bloodbeak
    --BPBID_Arrays.BasePetStats[1469] = ??? -- NEW: Junglebeak
    --BPBID_Arrays.BasePetStats[1470] = ??? -- NEW: Axebeak Hatchling
    --BPBID_Arrays.BasePetStats[1471] = ??? -- NEW: Fruit Hunter
    BPBID_Arrays.BasePetStats[1472] = {9.79, 16.5, 6.25} -- NEW: Gnawface
    BPBID_Arrays.BasePetStats[1473] = {9.79, 14.5, 7.75} -- NEW: Carrotus Maximus
    BPBID_Arrays.BasePetStats[1474] = {8.935, 15.25, 7.4} -- NEW: Gorefu
    --BPBID_Arrays.BasePetStats[1475] = ??? -- TAMER: Otto
    --BPBID_Arrays.BasePetStats[1476] = ??? -- TAMER: Mr. Pointy
    --BPBID_Arrays.BasePetStats[1477] = ??? -- TAMER: Syd
    --BPBID_Arrays.BasePetStats[1478] = ??? -- NEW: Syd the Squid
    --BPBID_Arrays.BasePetStats[1479] = ??? -- TAMER: Brutus
    --BPBID_Arrays.BasePetStats[1480] = ??? -- TAMER: Quintessence of Light
    --BPBID_Arrays.BasePetStats[1482] = ??? -- TAMER: Rukus
    --BPBID_Arrays.BasePetStats[1483] = ??? -- TAMER: Mr. Terrible
    --BPBID_Arrays.BasePetStats[1484] = ??? -- TAMER: Carroteye
    --BPBID_Arrays.BasePetStats[1485] = ??? -- TAMER: Sloppus
    --BPBID_Arrays.BasePetStats[1486] = ??? -- TAMER: The Beakinator
    --BPBID_Arrays.BasePetStats[1487] = ??? -- TAMER: King Floret
    --BPBID_Arrays.BasePetStats[1488] = ??? -- TAMER: Queen Floret
    --BPBID_Arrays.BasePetStats[1489] = ??? -- TAMER: Kromli
    --BPBID_Arrays.BasePetStats[1490] = ??? -- TAMER: Gromli
    --BPBID_Arrays.BasePetStats[1492] = ??? -- TAMER: Grubbles
    --BPBID_Arrays.BasePetStats[1493] = ??? -- TAMER: Stings
    --BPBID_Arrays.BasePetStats[1494] = ??? -- TAMER: Scrags
    --BPBID_Arrays.BasePetStats[1495] = ??? -- NEW: Ore Eater
    --BPBID_Arrays.BasePetStats[1496] = ??? -- TAMER: Jahan
    --BPBID_Arrays.BasePetStats[1497] = ??? -- TAMER: Samm
    --BPBID_Arrays.BasePetStats[1498] = ??? -- TAMER: Archimedes
    --BPBID_Arrays.BasePetStats[1499] = ??? -- TAMER: Fiero
    --BPBID_Arrays.BasePetStats[1500] = ??? -- TAMER: Tirs
    --BPBID_Arrays.BasePetStats[1501] = ??? -- TAMER: Rockbiter
    --BPBID_Arrays.BasePetStats[1502] = ??? -- TAMER: Stonechewer
    --BPBID_Arrays.BasePetStats[1503] = ??? -- TAMER: Acidtooth
    ...
    --BPBID_Arrays.BasePetStats[1511] = ??? -- NEW: Lovebird Hatchling
    --BPBID_Arrays.BasePetStats[1514] = ??? -- NEW: Mystical Spring Bouquet
    --BPBID_Arrays.BasePetStats[1515] = ??? -- NEW: Stonegrinder
    --BPBID_Arrays.BasePetStats[1516] = ??? -- NEW: Bush Chicken
    --BPBID_Arrays.BasePetStats[1517] = ??? -- NEW: Blazing Cindercrawler
    --BPBID_Arrays.BasePetStats[1518] = ??? -- NEW: Stout Alemental
    --BPBID_Arrays.BasePetStats[1519] = ??? -- TAMER: Limbflayer
    --BPBID_Arrays.BasePetStats[1521] = ??? -- NEW: Cursed Birman
    --BPBID_Arrays.BasePetStats[1523] = ??? -- NEW: Widget the Departed
    BPBID_Arrays.BasePetStats[1524] = {8, 8, 8} -- NEW: Netherspawn, Spawn of Netherspawn
    --BPBID_Arrays.BasePetStats[1530] = ??? -- NEW: Frostwolf Ghostpup
    --BPBID_Arrays.BasePetStats[1531] = ??? -- NEW: Ancient Nest Guardian
    --BPBID_Arrays.BasePetStats[1532] = ??? -- NEW: Ikky
    --BPBID_Arrays.BasePetStats[1533] = ??? -- NEW: Lanticore Spawnling
    --BPBID_Arrays.BasePetStats[1536] = ??? -- TAMER: Zangar Spore
    --BPBID_Arrays.BasePetStats[1537] = ??? -- NEW: Crimson Spore
    --BPBID_Arrays.BasePetStats[1538] = ??? -- NEW: Umbrafen Spore
    --BPBID_Arrays.BasePetStats[1539] = ??? -- TAMER: Seaborne Spore
    BPBID_Arrays.BasePetStats[1540] = {8, 8, 8} -- NEW: Brilliant Spore
    BPBID_Arrays.BasePetStats[1541] = {8, 8.5, 7.5} -- NEW: Hydraling
    --BPBID_Arrays.BasePetStats[1542] = ??? -- NEW: Frostwolf Pup
    --BPBID_Arrays.BasePetStats[1543] = ??? -- NEW: Pygmy Cow
    --BPBID_Arrays.BasePetStats[1544] = ??? -- NEW: Hatespark the Tiny
    --BPBID_Arrays.BasePetStats[1545] = ??? -- NEW: Firewing
    --BPBID_Arrays.BasePetStats[1546] = ??? -- NEW: Stormwing
    --BPBID_Arrays.BasePetStats[1547] = ??? -- TAMER: Pixiebell
    --BPBID_Arrays.BasePetStats[1548] = ??? -- TAMER: Doodle
    --BPBID_Arrays.BasePetStats[1549] = ??? -- TAMER: Tally
    --BPBID_Arrays.BasePetStats[1550] = ??? -- TAMER: Wolfus
    --BPBID_Arrays.BasePetStats[1552] = ??? -- TAMER: Fangra
    --BPBID_Arrays.BasePetStats[1553] = ??? -- TAMER: Wolfgar
    ...
    --BPBID_Arrays.BasePetStats[1557] = ??? -- TAMER: Darkwing
    --BPBID_Arrays.BasePetStats[1558] = ??? -- TAMER: The Great Kaliri
    --BPBID_Arrays.BasePetStats[1559] = ??? -- TAMER: Apexis Guardian
    --BPBID_Arrays.BasePetStats[1560] = ??? -- TAMER: Serendipity
    --BPBID_Arrays.BasePetStats[1561] = ??? -- TAMER: Grace
    --BPBID_Arrays.BasePetStats[1562] = ??? -- TAMER: Atonement
    --BPBID_Arrays.BasePetStats[1563] = ??? -- NEW: Bronze Whelpling
    BPBID_Arrays.BasePetStats[1564] = {8, 8, 8} -- NEW: Doom Bloom
    --BPBID_Arrays.BasePetStats[1565] = ??? -- NEW: Mechanical Scorpid
    --BPBID_Arrays.BasePetStats[1566] = ??? -- NEW: Everbloom Peachick
    --BPBID_Arrays.BasePetStats[1567] = ??? -- NEW: Sentinel's Companion
    --BPBID_Arrays.BasePetStats[1568] = ??? -- NEW: Puddle Terror
    ...
    --BPBID_Arrays.BasePetStats[1589] = ??? -- TAMER: Crimsonwing Moth
    --BPBID_Arrays.BasePetStats[1590] = ??? -- NEW: Swamplighter Firefly
    --BPBID_Arrays.BasePetStats[1591] = ??? -- TAMER: Violet Firefly
    --BPBID_Arrays.BasePetStats[1592] = ??? -- TAMER: Sapphire Firefly
    BPBID_Arrays.BasePetStats[1593] = {8, 7.5, 8.5} -- NEW: Waterfly
    BPBID_Arrays.BasePetStats[1594] = {8, 8, 8} -- NEW: Mudback Calf
    --BPBID_Arrays.BasePetStats[1595] = ??? -- NEW: Flat-Tooth Calf
    ...
    --BPBID_Arrays.BasePetStats[1603] = ??? -- NEW: Argi
    --BPBID_Arrays.BasePetStats[1604] = ??? -- TAMER: Unused
    --BPBID_Arrays.BasePetStats[1605] = ??? -- NEW: Trunks
    --BPBID_Arrays.BasePetStats[1607] = ??? -- TAMER: Gorefu
    --BPBID_Arrays.BasePetStats[1608] = ??? -- TAMER: Carrotus Maximus
    --BPBID_Arrays.BasePetStats[1609] = ??? -- TAMER: Gnawface
    --BPBID_Arrays.BasePetStats[1610] = ??? -- TAMER: Unborn Val'kyr
    --BPBID_Arrays.BasePetStats[1615] = ??? -- NEW: Parched Lizard
    ...
    --BPBID_Arrays.BreedsPerSpecies[1403] = {???} -- NEW: Mechanical Axebeak
    --BPBID_Arrays.BreedsPerSpecies[1409] = {???} -- TAMER: Eleanor
    --BPBID_Arrays.BreedsPerSpecies[1410] = {???} -- TAMER: Mechanical Training Dummy
    --BPBID_Arrays.BreedsPerSpecies[1411] = {???} -- NEW: Royal Peacock
    --BPBID_Arrays.BreedsPerSpecies[1412] = {???} -- NEW: Lifelike Mechanical Frostboar
    ...
    --BPBID_Arrays.BreedsPerSpecies[1424] = {???} -- TAMER: Gyrexle, the Eternal Mechanic
    BPBID_Arrays.BreedsPerSpecies[1426] = {6} -- NEW: Elekk Plushie
    --BPBID_Arrays.BreedsPerSpecies[1427] = {???} -- NEW: Gnawtooth Rat
    ...
    --BPBID_Arrays.BreedsPerSpecies[1434] = {???} -- NEW: Sun Sproutling
    BPBID_Arrays.BreedsPerSpecies[1435] = {6} -- NEW: Leatherhide Runt
    BPBID_Arrays.BreedsPerSpecies[1441] = {3, 12} -- NEW: Mud Jumper
    --BPBID_Arrays.BreedsPerSpecies[1442] = {???} -- NEW: Ghastly Kid
    --BPBID_Arrays.BreedsPerSpecies[1443] = {???} -- TAMER: Idol of Decay
    --BPBID_Arrays.BreedsPerSpecies[1444] = {???} -- TAMER: Wishbright Lantern
    --BPBID_Arrays.BreedsPerSpecies[1446] = {???} -- NEW: Meadowstomper Calf
    ...
    BPBID_Arrays.BreedsPerSpecies[1455] = {11} -- NEW: Mossbite Skitterer
    --BPBID_Arrays.BreedsPerSpecies[1456] = {???} -- NEW: Thicket Skitterer
    --BPBID_Arrays.BreedsPerSpecies[1457] = {???} -- NEW: Icespine Hatchling
    --BPBID_Arrays.BreedsPerSpecies[1458] = {???} -- NEW: Bone Wasp
    --BPBID_Arrays.BreedsPerSpecies[1462] = {???} -- NEW: Bloodsting Wasp
    --BPBID_Arrays.BreedsPerSpecies[1463] = {???} -- NEW: Wood Wasp
    --BPBID_Arrays.BreedsPerSpecies[1464] = {???} -- NEW: Twilight Wasp
    --BPBID_Arrays.BreedsPerSpecies[1465] = {???} -- NEW: Amberbarb Wasp
    ...
    --BPBID_Arrays.BreedsPerSpecies[1469] = {???} -- NEW: Junglebeak
    --BPBID_Arrays.BreedsPerSpecies[1470] = {???} -- NEW: Axebeak Hatchling
    --BPBID_Arrays.BreedsPerSpecies[1471] = {???} -- NEW: Fruit Hunter
    BPBID_Arrays.BreedsPerSpecies[1472] = {5} -- NEW: Gnawface
    BPBID_Arrays.BreedsPerSpecies[1473] = {4} -- NEW: Carrotus Maximus
    ...
    --BPBID_Arrays.BreedsPerSpecies[1478] = {???} -- NEW: Syd the Squid
    ...
    BPBID_Arrays.BreedsPerSpecies[1532] = {10} -- NEW: Ikky
    --BPBID_Arrays.BreedsPerSpecies[1533] = {???} -- NEW: Lanticore Spawnling
    --BPBID_Arrays.BreedsPerSpecies[1536] = {???} -- TAMER: Zangar Spore
    --BPBID_Arrays.BreedsPerSpecies[1537] = {???} -- NEW: Crimson Spore
    --BPBID_Arrays.BreedsPerSpecies[1538] = {???} -- NEW: Umbrafen Spore
    --BPBID_Arrays.BreedsPerSpecies[1539] = {???} -- TAMER: Seaborne Spore
    BPBID_Arrays.BreedsPerSpecies[1540] = {8} -- NEW: Brilliant Spore
    BPBID_Arrays.BreedsPerSpecies[1541] = {11} -- NEW: Hydraling
    --BPBID_Arrays.BreedsPerSpecies[1542] = {???} -- NEW: Frostwolf Pup
    --BPBID_Arrays.BreedsPerSpecies[1543] = {???} -- NEW: Pygmy Cow
    --BPBID_Arrays.BreedsPerSpecies[1544] = {???} -- NEW: Hatespark the Tiny
    --BPBID_Arrays.BreedsPerSpecies[1545] = {???} -- NEW: Firewing
    --BPBID_Arrays.BreedsPerSpecies[1546] = {???} -- NEW: Stormwing
    --BPBID_Arrays.BreedsPerSpecies[1547] = {???} -- TAMER: Pixiebell
    --BPBID_Arrays.BreedsPerSpecies[1548] = {???} -- TAMER: Doodle
    --BPBID_Arrays.BreedsPerSpecies[1549] = {???} -- TAMER: Tally
    --BPBID_Arrays.BreedsPerSpecies[1550] = {???} -- TAMER: Wolfus
    --BPBID_Arrays.BreedsPerSpecies[1552] = {???} -- TAMER: Fangra
    --BPBID_Arrays.BreedsPerSpecies[1553] = {???} -- TAMER: Wolfgar
    ...
    --BPBID_Arrays.BreedsPerSpecies[1557] = {???} -- TAMER: Darkwing
    --BPBID_Arrays.BreedsPerSpecies[1558] = {???} -- TAMER: The Great Kaliri
    --BPBID_Arrays.BreedsPerSpecies[1559] = {???} -- TAMER: Apexis Guardian
    --BPBID_Arrays.BreedsPerSpecies[1560] = {???} -- TAMER: Serendipity
    --BPBID_Arrays.BreedsPerSpecies[1561] = {???} -- TAMER: Grace
    --BPBID_Arrays.BreedsPerSpecies[1562] = {???} -- TAMER: Atonement
    --BPBID_Arrays.BreedsPerSpecies[1563] = {???} -- NEW: Bronze Whelpling
    BPBID_Arrays.BreedsPerSpecies[1564] = {7} -- NEW: Doom Bloom
    --BPBID_Arrays.BreedsPerSpecies[1565] = {???} -- NEW: Mechanical Scorpid
    --BPBID_Arrays.BreedsPerSpecies[1566] = {???} -- NEW: Everbloom Peachick
    --BPBID_Arrays.BreedsPerSpecies[1567] = {???} -- NEW: Sentinel's Companion
    --BPBID_Arrays.BreedsPerSpecies[1568] = {???} -- NEW: Puddle Terror
    ...
    --BPBID_Arrays.BreedsPerSpecies[1605] = {???} -- NEW: Trunks
    ...
    --BPBID_Arrays.BreedsPerSpecies[1615] = {???} -- NEW: Parched Lizard
end