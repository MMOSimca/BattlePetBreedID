...
Last Update: Patch 7.0.3 Live; @file-date-iso@
...
function BPBID_Arrays.InitializeArrays()
    ...
    --BPBID_Arrays.BreedsPerSpecies[1742] = {???} -- TAMER: Master Tamer Flummox
    ...
    --BPBID_Arrays.BreedsPerSpecies[1770] = {???} -- TAMER: Thrugtusk
    --BPBID_Arrays.BreedsPerSpecies[1771] = {???} -- TAMER: Baeloth
    --BPBID_Arrays.BreedsPerSpecies[1772] = {???} -- TAMER: Wumpas
    ...
    --BPBID_Arrays.BreedsPerSpecies[1790] = {???} -- TAMER: Lil' Spirit Guide
    --BPBID_Arrays.BreedsPerSpecies[1791] = {???} -- TAMER: Quillino
    --BPBID_Arrays.BreedsPerSpecies[1792] = {???} -- TAMER: Fethyr
    --BPBID_Arrays.BreedsPerSpecies[1793] = {???} -- TAMER: Egcellent
    --BPBID_Arrays.BreedsPerSpecies[1794] = {???} -- TAMER: Red Wire
    --BPBID_Arrays.BreedsPerSpecies[1795] = {???} -- TAMER: Sir Murkeston
    --BPBID_Arrays.BreedsPerSpecies[1796] = {???} -- TAMER: Coach
    --BPBID_Arrays.BreedsPerSpecies[1797] = {???} -- TAMER: Greatest Foe
    --BPBID_Arrays.BreedsPerSpecies[1798] = {???} -- TAMER: Gulp
    ...
    --BPBID_Arrays.BreedsPerSpecies[1811] = {???} -- TAMER: Rocko
    --BPBID_Arrays.BreedsPerSpecies[1815] = {???} -- TAMER: Heliosus
    ...
    --BPBID_Arrays.BreedsPerSpecies[1843] = {???} -- TAMER: Hungry Icefang
    --BPBID_Arrays.BreedsPerSpecies[1846] = {???} -- TAMER: Globs
    --BPBID_Arrays.BreedsPerSpecies[1847] = {???} -- TAMER: Trixy
    --BPBID_Arrays.BreedsPerSpecies[1848] = {???} -- TAMER: Nightmare Sprout
    --BPBID_Arrays.BreedsPerSpecies[1849] = {???} -- TAMER: The Maw
    ...
    --BPBID_Arrays.BreedsPerSpecies[1855] = {???} -- TAMER: Splint Jr.
    ...
    --BPBID_Arrays.BreedsPerSpecies[1860] = {???} -- TAMER: Ancient Catacomb Spider
    --BPBID_Arrays.BreedsPerSpecies[1861] = {???} -- TAMER: Catacomb Bat
    --BPBID_Arrays.BreedsPerSpecies[1862] = {???} -- TAMER: Catacomb Snake
    ...
    --BPBID_Arrays.BreedsPerSpecies[1873] = {???} -- TAMER: Gusteau
    --BPBID_Arrays.BreedsPerSpecies[1874] = {???} -- TAMER: Remy
    --BPBID_Arrays.BreedsPerSpecies[1875] = {???} -- TAMER: Dinner
    ...
    --BPBID_Arrays.BreedsPerSpecies[1880] = {???} -- TAMER: Stitches Jr. Jr.
    --BPBID_Arrays.BreedsPerSpecies[1881] = {???} -- TAMER: Lil'idan
    --BPBID_Arrays.BreedsPerSpecies[1882] = {???} -- TAMER: Chromadon
    ...
    --BPBID_Arrays.BreedsPerSpecies[1891] = {???} -- TAMER: Vinu
    --BPBID_Arrays.BreedsPerSpecies[1892] = {???} -- TAMER: Subjugated Tadpole
    --BPBID_Arrays.BreedsPerSpecies[1893] = {???} -- TAMER: Allured Tadpole
    --BPBID_Arrays.BreedsPerSpecies[1894] = {???} -- TAMER: Confused Tadpole
    --BPBID_Arrays.BreedsPerSpecies[1895] = {???} -- TAMER: Hungry Owl
    --BPBID_Arrays.BreedsPerSpecies[1896] = {???} -- TAMER: Hungry Rat
    --BPBID_Arrays.BreedsPerSpecies[1897] = {???} -- TAMER: Breezy Book
    --BPBID_Arrays.BreedsPerSpecies[1898] = {???} -- TAMER: Helpful Spirit
    --BPBID_Arrays.BreedsPerSpecies[1899] = {???} -- TAMER: Delicate Moth
