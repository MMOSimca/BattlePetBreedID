...
Last Update: Patch 11.1.7 Live; @file-date-iso@
...
function BPBID_Arrays.InitializeArrays()
    ...
    BPBID_Arrays.BasePetStats[4234] = {9.5, 8, 6.5}
    ...
    BPBID_Arrays.BasePetStats[4532] = {8.25, 8, 7.75}
    ...
    BPBID_Arrays.BreedsPerSpecies[4532] = {7}
