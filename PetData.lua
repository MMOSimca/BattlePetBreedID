...
function BPBID_Arrays.InitializeArrays()
    ...
    --BPBID_Arrays.BreedsPerSpecies[1665] = {???} -- NEW: Ghostshell Crab
    --BPBID_Arrays.BreedsPerSpecies[1666] = {???} -- NEW: Blorp
    BPBID_Arrays.BreedsPerSpecies[1668] = {7,8} -- NEW: Crusher
    --BPBID_Arrays.BreedsPerSpecies[1671] = {???} -- TAMER: 
    BPBID_Arrays.BreedsPerSpecies[1672] = {6} -- NEW: Corrupted Nest Guardian
    --BPBID_Arrays.BreedsPerSpecies[1673] = {???} -- TAMER: 
    --BPBID_Arrays.BreedsPerSpecies[1674] = {???} -- TAMER: 
    --BPBID_Arrays.BreedsPerSpecies[1675] = {???} -- TAMER: 
    --BPBID_Arrays.BreedsPerSpecies[1676] = {???} -- TAMER: 
    ...
    --BPBID_Arrays.BreedsPerSpecies[1685] = {???} -- TAMER: 
    --BPBID_Arrays.BreedsPerSpecies[1686] = {???} -- TAMER: 
    ...
    --BPBID_Arrays.BreedsPerSpecies[1693] = {???} -- NEW: Blazing Firehawk
end
